  ...
  return (
    <motion.div className=" about-container bg-zinc-900">
      ...
      <p  onMouseEnter={() => {
        ...
        My name is <span className='text-green-500'>Nitish Kumar Pandit</span>. I'm aspiring <strong>FULL Stack Developer</strong>, committed to making a positive impact in the professional world.
        Driven to create seamless and <span className='text-blue-500'>interactive user experiences</span>,  I'm building my skills as a Full-Stack Developer
